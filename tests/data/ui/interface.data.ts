...
export const UIData: UITestData = {
  ...
  selectors: {
    ...
    searchInput:
      '[data-testid="pokemon-search-input"], input[placeholder*="Pokemon"], #search-input',
    ...
    randomLegendaryButton:
      '[data-testid="random-legendary-button"], .random-legendary-btn, button:has-text("Random Legendary")',
    ...
    addToTeamButton:
      '[data-testid="add-to-team"], .add-to-team-btn, button:has-text("Add to Team")',
    removeFromTeamButton:
      '[data-testid="remove-from-team"], .remove-from-team-btn, button:has-text("Remove")',
